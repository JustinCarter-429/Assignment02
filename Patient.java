 ...
 *
 * @author CS 2420 course staff and Justin Carter and Anthony
 * @version 01/16/2026
 */
public class Patient {
	 ...
	 *         false otherwise.
	 */
	@Override // it is more effiencient to check if other is not an instance of patient , then cast paitent 
	// to other . After then run the if statement. 
	public boolean equals(Object other) {
	    if (!(other instanceof Patient)) return false;
	    Patient otherPatient = (Patient) other;

	    if (this.getUHealthID() == null || otherPatient.getUHealthID() == null)
	        return false;

	    return this.getUHealthID().equals(otherPatient.getUHealthID());
	}
